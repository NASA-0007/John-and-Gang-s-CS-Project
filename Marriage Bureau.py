...
conn=sql.connect(host='localhost',user='root',passwd='glhf123',database='marriage_bureaw_management')
c1=conn.cursor()
c1.execute('create table legends_details(name varchar(20),address varchar(200),nationality varchar(100),appearence varchar(100),age int,profession varchar(255),phone_no bigint(200);')
c1.execute('create table girls_details(name varchar(100),address varchar(100),nationality varchar(50),appearence varchar(25),age int(4),profession varchar(65),phone_no varchar(15);')
